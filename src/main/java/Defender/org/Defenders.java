...
/**
 * This class is used to construct defenders to defend about the assets node and to prevent attackers
 */
public class Defenders implements Cloneable {
     ...
     *
     * @param invest_d Referred to first defender
     */
    ...
    @Override
    public Defenders clone() {
        try {
            return (Defenders) super.clone();
        } catch (CloneNotSupportedException ex) {
            throw new IllegalArgumentException("Crashed"); // should never happen
        }
    }
