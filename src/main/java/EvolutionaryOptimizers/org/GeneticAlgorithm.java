...
/**
 * This class is used to apply Deferential Evolution (similar to Genetic Algorithm) algorithm to find top-k paths between A and B
 * <pre>
...
public class GeneticAlgorithm extends FitnessFunction {
    ...
    /**
     * This constructor is used to initialize several parameters which are required for the DE algorithm
    ...
    /**
     * This method is used to apply crossover on two given parents
     ...
     * @param population The current generation of solutions
     */
